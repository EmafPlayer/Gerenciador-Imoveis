            ...
            <main className="h-screen">
                ...
                <div className={twMerge("gap-16 pt-[140px]", isHighScreen ? 'flex items-center justify-center' : 'flex flex-col items-center')}>
                    ...
                    <div className="flex items-center gap-2 sm:gap-7">
                        ...
                        <img src={apiFotos +imovel.fotos[contador].endereco} alt="foto do imóvel" className=" h-[300px] sm:h-[400px] md:h-[500px] xl:h-[700px] w-full sm:w-[500px] md:w-[700px] lg:w-[900px] xl:w-[950px] rounded-3xl shadow-md"/>
                                ...
                                <div className="flex justify-around">
                                    <div>
                                        ...
                                        <div className="flex items-end">
                                            <h1 className="text-[30px] text-zinc-700 font-bold">{imovel.valor_aluguel.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}</h1>
                                            <h4 className="text-[15px] pb-2">/mês</h4>
                                        </div>
                                    </div>
                                    <div className="">
                                        <h2 className="text-[18px]">Venda</h2>
                                        <h1 className="text-[30px] text-zinc-700 font-bold">{imovel.valor_venda.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}</h1>
                                    </div>
                                </div>
                            </div>
