...
export function CriarVisitas ( {setModal, id_imovel}: props ) {
    ...
    return (
            <div className="bg-gray-500 fixed inset-0 z-10 flex items-center justify-center bg-opacity-75 py-4 sm:py-0 px-2 sm:px-0">
                <form onSubmit={handleSubmit(submit)} className="bg-white w-full sm:w-[1024px] px-6 sm:px-12 py-8 sm:py-12 h-full sm:h-[700px] rounded-lg">
                    <div className="flex items-center justify-between mb-8 sm:mb-12">
                        <h1 className="text-[40px] sm:text-[45px] font-bold">Criar Visitas</h1>
                        <div className="flex items-center gap-3">
                            <button onClick={() => setModal(false)} className="text-white text-[20px] bg-red-900 p-3 rounded-md ml-6"><MdClose /></button>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-10 gap-y-8 w-full">
                        ...
                        <div className="col-span-2 sm:col-span-2 lg:col-span-3 lg:mt-6">
                            <div className="flex items-center gap-2 mb-1">
                        ...
                        <div className="text-center sm:text-right mt-12 sm:mt-24">
